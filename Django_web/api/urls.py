...
urlpatterns = [
    ...
    path('stock/<str:productid>/<str:productsize>/', views.getStock, name='stock'),
    path('stock/update/<str:updt>/<str:productid>/<str:productsize>/', views.updateStock, name='updtstock'),
    ...
    path('orderid/cancel/<str:pk>/', views.updateCancelled, name='cancel'),
